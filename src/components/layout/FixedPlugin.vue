...
export default {
  ...
  data() {
    return {
      ...
      isOpen: false,
      backgroundImage: "../../static/img/sidebar-2.jpg",
      sidebarColors: [
      ...
      sidebarImages: [
        { image: "../../static/img/sidebar-1.jpg", active: false },
        { image: "../../static/img/sidebar-2.jpg", active: true },
        { image: "../../static/img/sidebar-3.jpg", active: false },
        { image: "../../static/img/sidebar-4.jpg", active: false }
      ]
    };
  },
  methods: {
